			...
			<aui:fieldset>
				...
				<div id="<portlet:namespace />authenticationOptions">
						...
						<aui:field-wrapper label="user-name">
							...
							<tr>
								...
								<td>
									...
									<%-- NLcom BY --%>
									<aui:input cssClass="lfr-input-text-container" label="value" name="preferences--formUserName--" type="text" value="<%= formUserName %>" />
									<%-- NLcom END REPLACE --%>
								</td>
							</tr>
							</table>
						...
						<aui:field-wrapper name="password">
							...
							<tr>
								...
								<td>
									...
									<%-- NLcom BY --%>
									<aui:input cssClass="lfr-input-text-container" label="value" name="preferences--formPassword--" type="text" value="<%= formPassword %>" />
									<%-- NLcom END REPLACE --%>
								</td>
							</tr>
							</table>
					...
					<div id="<portlet:namespace />basicAuthOptions">
						...
						<%-- NLcom BY --%>
						<aui:input cssClass="lfr-input-text-container" label="user-name" name="preferences--basicUserName--" type="text" value="<%= basicUserName %>" />
						<%-- NLcom END REPLACE --%>
						
						<%-- NLcom BEGIN REPLACE --%>
						<%-- <aui:input cssClass="lfr-input-text-container" label="password" name="preferences--basicPassword--" type="text" value="<%= password %>" /> --%>
						<%-- NLcom BY --%>
						<aui:input cssClass="lfr-input-text-container" label="password" name="preferences--basicPassword--" type="text" value="<%= basicPassword %>" />
						<%-- NLcom END REPLACE --%>
					</div>
				</div>
			</aui:fieldset>
