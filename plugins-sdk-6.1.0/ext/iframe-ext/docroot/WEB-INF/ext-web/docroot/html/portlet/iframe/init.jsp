...
/* NLcom BY */
String formUserName = preferences.getValue("formUserName", StringPool.BLANK);
String basicUserName = preferences.getValue("basicUserName", StringPool.BLANK);
/* NLcom END REPLACE */
...
/* NLcom BY */
String formPassword = preferences.getValue("formPassword", StringPool.BLANK);
String basicPassword = preferences.getValue("basicPassword", StringPool.BLANK);
/* NLcom END REPLACE */
