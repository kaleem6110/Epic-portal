	...
	protected String transformSrc(
		...
		if (auth) {
			if (authType.equals("basic")) {
				...
				/* NLcom BEGIN ADD */
				String basicUserName = getBasicUserName(renderRequest, renderResponse);
				String basicPassword = getBasicPassword(renderRequest, renderResponse);
				/* NLcom END ADD */

				src = protocol + basicUserName + ":" + basicPassword + "@" + url;
				
				System.out.println( " basic KALEEM " + src );
			}
			else {
